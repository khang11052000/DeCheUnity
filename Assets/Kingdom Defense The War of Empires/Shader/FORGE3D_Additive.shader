...
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = ((xlv_COLOR * _TintColor) * texture2D (_MainTex, xlv_TEXCOORD0));
...
void main ()
{
  ...
  lowp vec4 tmpvar_3;
  tmpvar_3 = ((tmpvar_1 * _TintColor) * texture2D (_MainTex, xlv_TEXCOORD0));
...
void main()
{
    ...
    u_xlat16_0.w = u_xlat0.x * _TintColor.w;
